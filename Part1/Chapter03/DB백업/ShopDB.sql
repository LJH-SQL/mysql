...
INSERT INTO `deletedmembertbl` VALUES ('Dang','당탕이','경기 부천시 중동','2021-08-24');
...
INSERT INTO `membertbl` VALUES ('Figure','연아','경기도 군포시 당정동'),('Han','한주연','연천 남구 주안동'),('Jee','지운이','서울 은평구 중산동'),('Sang','상길이','경기 성남시 분당구');
...
-- Dump completed on 2021-08-30 16:26:21
